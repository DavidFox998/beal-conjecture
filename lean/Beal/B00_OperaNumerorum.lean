...
def OperaNumerorum_Audit_v2 : String := "Core [] ; S2(2)=0 rfl [] ; Ribet proved [] from S2DimZero (p=5 N=10 witnesses) ; Mazur+Wiles 2 explicit axioms ; frey_modularity_of_S2_vanishes depends on [mazur wiles] only"
