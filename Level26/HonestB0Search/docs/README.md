...
| [`kolyvagin-rank0-v29/`](kolyvagin-rank0-v29/) | Parent names as theorems; `|Sel₂|=1`, `3·7=21`, `L/Ω`. `MW_rank_zero_fintype` stays `def Prop` on the parent. |
| [`tate-neron-v28/`](tate-neron-v28/) | v28 `928=2⁵·29`, `v₂(Δ)=6`, `v₂₉=8`. |
| [`mazur-cusps-v28/`](mazur-cusps-v28/) | v28 genus 0, cusp Finset `card=2`. |
| [`ribet-no-newforms-v28/`](ribet-no-newforms-v28/) | v28 matching Finset `card=0`. LMFDB new dim 1. |
| [`kolyvagin-fintype-subsingleton-v28/`](kolyvagin-fintype-subsingleton-v28/) | v28 `Nonempty(Fintype)→Fintype`. |
| [`tate-v29/`](tate-v29/) | v27 Tate Δ identity, `928/29=32`. |
| [`mazur-x0-13/`](mazur-x0-13/) | v27 `|SL₂|=2184`, `48<2184`, genus 0. |
| [`ribet-928-32/`](ribet-928-32/) | v27 numeral `928/29=32`. |
| [`kolyvagin-fintype/`](kolyvagin-fintype/) | v27 `|Sel₂|=1`, `L/Ω`. |
