---
name: BSD repository boundary
description: Scope rule for the separate Birch-and-Swinnerton-Dyer repository.
---

Treat the separate `Birch-and-Swinnerton-Dyer` repository as outside the active project scope. Do not start, continue, or suggest work there unless the user explicitly asks to reopen it.
