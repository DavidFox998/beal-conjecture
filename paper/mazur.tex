...
\texttt{\seqsplit{Serre\_non\_Borel\_mod13}},
and
\texttt{\seqsplit{mazur\_no\_Frey\_13\_isogeny}}
are theorems in this namespace. Each re-exports the inhabited conjunction of
Display~\ref{disp:mazur} with the genus Nat $0$; despite the
names, none of them states or proves that a rational $13$-isogeny
is excluded. On the parent file
\texttt{Mazur\_X0\_13\_No\_Isogeny.lean} those four names stay
\texttt{def Prop}, and it is that parent Prop, not the theorem in
this file, that would correspond to an actual exclusion statement.
...
not a Mathlib proof that the rational points are infinite, and it
is not Mazur's isogeny theorem. In particular, the introduction's
