...
// Module: Beal.B14_TateC4Nonzero
// Imports: Init Beal.B14_FreyTate Mathlib.Data.ZMod.Basic Mathlib.Tactic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B14__TateC4Nonzero(uint8_t builtin, lean_object* w) {
lean_object * res;
