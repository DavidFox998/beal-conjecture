...
lean_object* initialize_Beal_B00__OperaNumerorum(uint8_t builtin, lean_object*);
...
lean_object* initialize_Beal_B04__QExpansion__Core(uint8_t builtin, lean_object*);
...
lean_object* initialize_Beal_B14__PrimeNotDvd__Core(uint8_t builtin, lean_object*);
...
lean_object* initialize_Beal_B20__Beal__Core(uint8_t builtin, lean_object*);
...
lean_object* initialize_Beal_Experimental_Mathlib415QExpansionProbe(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_Beal_B00__OperaNumerorum(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Beal_B04__QExpansion__Core(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Beal_B14__PrimeNotDvd__Core(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Beal_B20__Beal__Core(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Beal_Experimental_Mathlib415QExpansionProbe(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
