...
edge obligation is localized rank-one `LocalizedRankOne`. Newform support witnesses are retained as `NewSubspaceSupportData`, and
...
EnrichedPlanSupplier
        ...
        ├── genuine submodule and pair-level q-expansion premise
         ├── restricted Ihara, typed Eutheos old/new geometry, and localized rank
         │   boundary
