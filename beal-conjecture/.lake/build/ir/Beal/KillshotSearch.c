...
// Module: Beal.KillshotSearch
// Imports: Init Beal.B01_Def_Core Beal.B14_FreyConductor_Core
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_KillshotSearch(uint8_t builtin, lean_object* w) {
lean_object * res;
