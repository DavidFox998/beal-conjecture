...
extern lean_object* l_Lean_Meta_Rfl_reflExt_config;
...
lean_dec(x_17);
x_21 = l_Lean_Meta_Rfl_reflExt_config;
lean_inc(x_6);
lean_inc(x_5);
lean_inc(x_4);
lean_inc(x_3);
...
lean_inc(x_58);
lean_dec(x_56);
x_59 = l_Lean_Expr_relSidesIfRefl_x3f___lambda__2___closed__2;
x_60 = l_Lean_Expr_relSidesIfRefl_x3f___lambda__2___closed__3;
x_61 = l_Lean_ScopedEnvExtension_getState___rarg(x_59, x_60, x_58);
lean_dec(x_58);
x_62 = l_Lean_Meta_Rfl_reflExt_config;
lean_inc(x_6);
lean_inc(x_5);
lean_inc(x_4);
lean_inc(x_3);
