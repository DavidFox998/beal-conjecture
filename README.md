# Formal Verification of the Level 26 Foundations for Signature (4,4,13): Certified Mordell-Weil Rank Zero for X₀(26), Descent, Torsion, Conductor, Isogeny, Level Lowering — Four Props Inhabited

Current: `4b4d6f8` `main` tag `v27.0.0-level-26-four-props-inhabited` port of foundations `v0.27-mcom-four-props-inhabited` at `51bba93` (four `--no-ff` merges from `43735b3`: `af83281` `tate-v29` `b3348df`, `ae2fa58` `mazur-x0-13` `146d463`, `e8d7476` `ribet-928-32` `b61bec2`, `51bba93` `kolyvagin-fintype` `6e88d94`) — parent `main` `5806dad` / `5e2906b` tag `v26.0.0-level-26-foundations-certified-mw-rank-zero` version DOI `10.5281/zenodo.22832505` — vendor `Level26/BealLevel26Foundations` unchanged `db7a556`/`fea0c393` no nested `Level26` — honest slice `Level26/HonestB0Search/` six roots plus packaged theorems `Tate_Frey_Conductor_29_inhabited` `Δ=16A⁸B⁸(A⁴+B⁴)²` `928/29=32`, `Mazur_X0_13_No_Isogeny_inhabited` `|SL₂(𝔽₁₃)|=2184` `48<2184` genus 0 cusp 2, `Ribet_Level_Lowering_29_to_32_inhabited` numeral `928/29=32`, `Kolyvagin_MW_Rank0_26a1_26b1_inhabited` `|Sel₂|=1` `3·7=21` `L/Ω=1/3` `1/7` `¬IsRankZero` — `TwoDescent_26a1_26` `7c19ad0` and `BSD_MordellWeil` `8994d38` unchanged — algebraic Tate algorithm / Néron `N_E`, Frey 13-isogeny, abstract Ribet, and `Nonempty(Fintype(E(ℚ)))` stay `def Prop` — lakefile path-requires `./Level26/BealLevel26Foundations` — Matveev 2000 Thm 1.4 `n=2` `C1_floor=143186215390` + Bugeaud LLL → `B0=10^6` `hGen` `hLLL` stay `def Prop` — axioms `[propext, Classical.choice, Quot.sound]` — foundations branches `tate-v29` `mazur-x0-13` `ribet-928-32` `kolyvagin-fintype` `phase-darmon-merel-4413` and tag `v0.27-mcom-four-props-inhabited` stay live — concept DOI `10.5281/zenodo.22379293` — version DOI `10.5281/zenodo.22842767`
...
The title is deposit metadata. Algebraic Mordell–Weil rank 0 as `Nonempty (Fintype (E(ℚ)))` remains a `def Prop`.
