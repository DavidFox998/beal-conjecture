# Formal Verification of the Level 26 Foundations for Signature (4,4,13): Certified Mordell-Weil Rank Zero for X₀(26), Descent, Torsion, Conductor, Isogeny, Level Lowering — Final Algebraic Props Inhabited

Current: `dc55259` `main` tag `v29.0.0-level-26-final-algebraic-props-inhabited` version DOI `10.5281/zenodo.22854603` — ports foundations `v0.29-mcom-final-algebraic-props-inhabited` at `bc7e93b` (four `--no-ff` merges from `a93402e`: `5a8dbbf` `tate-neron-final-v29` `11c0ad7`, `3af9424` `mazur-no-isogeny-final-v29` `2f4e16e`, `4f717e0` `ribet-928-to-32-final-v29` `5631fd1`, `bc7e93b` `kolyvagin-rank0-final-v29` `fc8c7a1`) — parent `main` `b780c9c` badge of v28 `v28.0.0-level-26-algebraic-props-inhabited` at `bd1400e` version DOI `10.5281/zenodo.22851334` — parent `6ccafbf` badge of v27 `v27.0.0-level-26-four-props-inhabited` at `4b4d6f8` version DOI `10.5281/zenodo.22842767` — vendor `Level26/BealLevel26Foundations` unchanged `db7a556`/`fea0c393` no nested `Level26` — honest slice `Level26/HonestB0Search/` v27 six roots plus v28 inhabited plus v29 finals `Tate_Frey_Conductor_29_Neron_final` displayed `N_E=928=2⁵·29`, `Mazur_X0_13_No_Isogeny_final` cusp Finset `card=2` `|SL₂|=2184`, `Ribet_Level_Lowering_29_to_32_final` matching Finset `card=0` `928/29=32`, `Kolyvagin_MW_Rank0_26a1_26b1_final` `|Sel₂|=1` `3·7=21` `L/Ω=1/3` `1/7` `¬IsRankZero` parent names as theorems — `TwoDescent_26a1_26` `7c19ad0` and `BSD_MordellWeil` `8994d38` unchanged — parent Tate algorithm / Néron `N_E`, `{2 cusps}=X₀(13)(ℚ)`, Sage `new_subspace dim=0`, and `MW_rank_zero_fintype` stay `def Prop` on parent files — lakefile path-requires `./Level26/BealLevel26Foundations` — Matveev 2000 Thm 1.4 `n=2` `C1_floor=143186215390` + Bugeaud LLL → `B0=10^6` `hGen` `hLLL` stay `def Prop` — axioms `[propext, Classical.choice, Quot.sound]` — Lean 4.12 explicit types `decide` not `native_decide` — foundations branches `tate-v29` `mazur-x0-13` `ribet-928-32` `kolyvagin-fintype` `tate-neron-v28` `mazur-cusps-v28` `ribet-no-newforms-v28` `kolyvagin-fintype-subsingleton-v28` `tate-neron-final-v29` `mazur-no-isogeny-final-v29` `ribet-928-to-32-final-v29` `kolyvagin-rank0-final-v29` `phase-darmon-merel-4413` and tags `v0.27` `v0.28` `v0.29` stay live — concept DOI `10.5281/zenodo.22379293` — prior version DOI `10.5281/zenodo.22851334`

[![Concept DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22379293.svg)](https://doi.org/10.5281/zenodo.22379293) [![v29.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22854603.svg)](https://doi.org/10.5281/zenodo.22854603) [![v28.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22851334.svg)](https://doi.org/10.5281/zenodo.22851334) [![v27.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22842767.svg)](https://doi.org/10.5281/zenodo.22842767) [![v26.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22832505.svg)](https://doi.org/10.5281/zenodo.22832505) [![CI](https://github.com/DavidFox998/beal-conjecture/actions/workflows/main.yml/badge.svg)](https://github.com/DavidFox998/beal-conjecture/actions/workflows/main.yml)
