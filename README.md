# Formal Verification of the Level 26 Foundations for Signature (4,4,13): Certified Mordell-Weil Rank Zero for X₀(26), Descent, Torsion, Conductor, Isogeny, Level Lowering — Algebraic Props Inhabited

Current: `bd1400e` `main` tag `v28.0.0-level-26-algebraic-props-inhabited` version DOI `10.5281/zenodo.22851334` — parent `6ccafbf` badge of v27 `v27.0.0-level-26-four-props-inhabited` at `4b4d6f8` version DOI `10.5281/zenodo.22842767` — ports foundations `v0.28-mcom-algebraic-props-inhabited` at `a93402e` (four `--no-ff` merges from `51bba93`: `51aff67` `tate-neron-v28` `6f67889`, `2b45118` `mazur-cusps-v28` `495421c`, `874ab68` `ribet-no-newforms-v28` `e80431f`, `a93402e` `kolyvagin-fintype-subsingleton-v28` `b01a399`) — parent `main` `5806dad` / `5e2906b` tag `v26.0.0-level-26-foundations-certified-mw-rank-zero` version DOI `10.5281/zenodo.22832505` — vendor `Level26/BealLevel26Foundations` unchanged `db7a556`/`fea0c393` no nested `Level26` — honest slice `Level26/HonestB0Search/` v27 six roots plus v28 `Tate_Frey_Conductor_29_Neron_inhabited` `928=2⁵·29` `v₂(Δ)=6` `v₂₉(Δ(29,1))=8`, `Mazur_X0_13_Cusps_Equals_Rationals_inhabited` genus 0 cusp Finset `card=2` `|SL₂|=2184`, `Ribet_No_Newforms_At_32_inhabited` matching Finset `card=0` Sturm `8` `928/29=32`, `Kolyvagin_Fintype_Subsingleton_inhabited` `Nonempty(Fintype)→Fintype` `|Sel₂|=1` `3·7=21` `L/Ω=1/3` `1/7` `¬IsRankZero` — `TwoDescent_26a1_26` `7c19ad0` and `BSD_MordellWeil` `8994d38` unchanged — parent Tate algorithm / Néron `N_E`, `{2 cusps}=X₀(13)(ℚ)`, Sage `new_subspace dim=0`, and `MW_rank_zero_fintype` stay `def Prop` — lakefile path-requires `./Level26/BealLevel26Foundations` — Matveev 2000 Thm 1.4 `n=2` `C1_floor=143186215390` + Bugeaud LLL → `B0=10^6` `hGen` `hLLL` stay `def Prop` — axioms `[propext, Classical.choice, Quot.sound]` — foundations branches `tate-v29` `mazur-x0-13` `ribet-928-32` `kolyvagin-fintype` `tate-neron-v28` `mazur-cusps-v28` `ribet-no-newforms-v28` `kolyvagin-fintype-subsingleton-v28` `phase-darmon-merel-4413` and tags `v0.27` `v0.28` stay live — concept DOI `10.5281/zenodo.22379293` — prior version DOI `10.5281/zenodo.22842767`

[![Concept DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22379293.svg)](https://doi.org/10.5281/zenodo.22379293) [![v28.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22851334.svg)](https://doi.org/10.5281/zenodo.22851334) [![v27.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22842767.svg)](https://doi.org/10.5281/zenodo.22842767) [![v26.0.0 DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22832505.svg)](https://doi.org/10.5281/zenodo.22832505) [![CI](https://github.com/DavidFox998/beal-conjecture/actions/workflows/main.yml/badge.svg)](https://github.com/DavidFox998/beal-conjecture/actions/workflows/main.yml)
...
The title is deposit metadata. Algebraic Mordell–Weil rank 0 as `Nonempty (Fintype (E(ℚ)))` remains a `def Prop`. `X₀(13)(ℚ)={2 cusps}` is literature-false (genus 0). LMFDB `S₂(Γ₀(32))` new dimension is **1**, not 0.
