...
// Module: Beal.B14_TateInImpliesOrd1
// Imports: Init Beal.B14_FreyTate Beal.B14_TateC4Nonzero Mathlib.Data.ZMod.Basic Mathlib.Tactic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_B14__TateInImpliesOrd1(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Beal_B14__TateC4Nonzero(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
