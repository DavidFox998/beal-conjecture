...
// Module: Beal.Galois.«02_ResidualRep»
// Imports: Init Beal.Galois.«01_Absolute» Beal.B14_FreyTate
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Beal_Galois_02__ResidualRep(uint8_t builtin, lean_object* w) {
lean_object * res;
